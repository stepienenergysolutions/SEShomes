(function () {
  ...
  root.innerHTML = `
    ...
    <main>
      ...
      <section class="campaign-highlight design-highlight" id="computer-design"><div class="wrap highlight-grid"><div><p class="eyebrow">See your project before construction</p><h2>Free Computer-Rendered Design</h2><p>Meet with SES Custom Homes to explore a computer-rendered concept for your ${config.serviceName.toLowerCase()} project and discuss the details that matter to you.</p></div><a href="#estimate-card" data-track="design_quote">Request My Free Design →</a></div></section>
